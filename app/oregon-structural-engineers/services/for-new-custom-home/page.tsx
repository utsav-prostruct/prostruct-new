      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
          <div className="mb-6 pb-4 border-b">
            <span className="text-sm text-gray-500">Page ID: 973</span>
          </div>
          ...
          <div className="space-y-4 text-gray-600">
            ...
            <p>
              ...
              <a
                href="https://prostructengineering.com/oregon-structural-engineers/services/for-new-custom-home/"
                target="_blank"
                rel="noopener"
                className="text-blue-600 hover:underline"
              >
                https://prostructengineering.com/oregon-structural-engineers/services/for-new-custom-home/
              </a>
            </p>
          </div>
